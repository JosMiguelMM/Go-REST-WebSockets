...
**Regla fundamental:** Como fuente base para cualquier pregunta o consulta sobre el código, siempre utiliza `codebase-memory-mcp` como fuente principal de mapa. Esta herramienta proporciona la referencia completa donde está ubicada cada archivo, función, estructura y patrón dentro del proyecto, permitiendo una navegación precisa y sin adivinanzas en el conocimiento del codebase.
